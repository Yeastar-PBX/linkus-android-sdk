...
public class MToastStyle implements IToastStyle<TextView> {
    ...
    protected int getTextColor(Context context) {
        return context.getResources().getColor(R.color.text_toast);
    }
    ...
    protected Drawable getBackgroundDrawable(Context context) {
        ...
        // 设置颜色
        drawable.setColor(context.getResources().getColor(R.color.bg_toast));
        // 设置圆角
